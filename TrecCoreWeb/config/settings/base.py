"""
Django settings for trecCoreWeb project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'treccoreweb.contrib.sites.migrations'
}
...
ACCOUNT_SIGNUP_FORM_CLASS = 'treccoreweb.allauth.forms.SignupForm'

ACCOUNT_ALLOW_REGISTRATION = env.bool('DJANGO_ACCOUNT_ALLOW_REGISTRATION', True)
ACCOUNT_ADAPTER = 'treccoreweb.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'treccoreweb.users.adapters.SocialAccountAdapter'
...
DOCUMENTS_URL = 'http://129.97.84.14:9000/docs'
